...
const ContactUs = () => {
  ...
  const SendMsg = (e: React.FormEvent) => {
    ...
    emailjs
      .send(
        "service_xm5fzxt", //service_xm5fzxt
        "template_z020el7", //template_z020el7
        templateParams,
        "7gCyhaZ6TZretd6ux" //7gCyhaZ6TZretd6ux
      )
            ...
            <ul className="footer footer-list">
              ...
              <li className="footer-item">
                ...
                <address className="contact-link address">
                  Kiet Group Of Institutiions, Ghaziabad, Uttar Pradesh, 201206
                </address>
              </li>
              <li className="footer-item">
